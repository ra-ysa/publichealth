...
- [Metodologia](#metodologia)
  - [Detalhamento do Projeto](#detalhamento-do-projeto)
    ...
    - [3. Geração de visualizações](#geração-de-visualizações)
    - [4. Definição e realização de análises estatísticas pertinentes](#definição-e-realização-de-análises-estatísticas-pertinentes)
    - [5. Compilação dos resultados](#compilação-dos-resultados)
    - [6. Atividades pervasivas](#atividades-pervasivas)
