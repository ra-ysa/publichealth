...
- <b>Gráficos</b>: Os gráficos foram produzidos no [código-fonte](https://github.com/ra-ysa/publichealth/tree/master/src "src") ``stats.py``, com a ferramenta Matplotlib. Seus resultados foram extraídos para [imagens](https://github.com/ra-ysa/publichealth/tree/master/assets/gr%C3%A1ficos "Gráficos") .jpg. 
