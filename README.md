...
O objetivo deste trabalho é, portanto, compreender quais são as melhores práticas ou métricas na oferta dos recursos selecionados de modo a garantir uma cobertura adequada de saúde, e como o Brasil se posiciona em relação a tais métricas, nacional e internacionalmente. 
